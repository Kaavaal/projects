...
function initSlicknavMenu() {
       $('.header-nav nav').slicknav({
            appendTo: '.header-top-2 .row',
            label: ''
        });
}
            ...
            if (!current.hasClass('active')) {
                ...
                if(current.hasClass('fa-th-large')){
                    ...
                    for (var i = 0; i < productCards.length; i++){
                        productCards.eq(i).addClass('col-xs-12');
                        productCards.eq(i).addClass('col-md-6');
                        productCards.eq(i).addClass('col-lg-6');
                        productCards.eq(i).addClass('col-xl-4');
                    ...
                    for (var i = 0; i < productCards.length; i++){
                        ...
                        productCards.eq(i).removeClass('col-xl-4');
                        productCards.eq(i).removeClass('col-md-6');
                        productCards.eq(i).removeClass('col-lg-6');
                        productCards.eq(i).removeClass('col-xs-12');
                    }
